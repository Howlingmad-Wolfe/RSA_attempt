...
def coprime( number_1, number_2 ):
	...
	common divisor. The order the numbers places in doesn't matter.
	The function will use the smaller number as the initial divisor.
...
def miller_rabin( number , pass_no = 1 ):
	...
	Preformes a Miller-Rabin (Rabin-Miller) test on a given number (number).
	...
	"""
	# odd_Filtering out any values that are even or equil to 1.
	if number <= 2:
		return False
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	def save_keys( self ):
		"""
		Saves generated RSA "key_ring" to a file.
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	def block( self ):
		...
		#	unpadded = self.bit_block_len - 11
			#block_data = 
